...
abstract class AppLocalizations {
  ...
  /// No description provided for @energyBarLabel.
  ///
  /// In id, this message translates to:
  /// **'Energi Ibadah'**
  String get energyBarLabel;

  /// No description provided for @questMapTitle.
  ///
  /// In id, this message translates to:
  /// **'Peta Perjalanan'**
  String get questMapTitle;
  ...
  /// No description provided for @jamRawanTitle.
  ///
  /// In id, this message translates to:
  /// **'Jam Rawan Lengah'**
  String get jamRawanTitle;

  /// No description provided for @pauseForMercyLabel.
  ///
  /// In id, this message translates to:
  /// **'Jeda untuk Kebaikan'**
  String get pauseForMercyLabel;
  ...
  /// No description provided for @errorDataCorrupt.
  ///
  /// In id, this message translates to:
  /// **'Data rusak'**
  String get errorDataCorrupt;
