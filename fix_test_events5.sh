...
sed -i "s/id: Uuid().v4() + i.toString(),/id: const Uuid().v4() + i.toString() + DateTime.now().microsecondsSinceEpoch.toString(),/g" app_islamic_v2/test/features/tracker/streak_test.dart
